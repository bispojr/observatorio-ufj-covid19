...
class SignInTest(TestCase):
    ...
    def setUp(self):
        self.user = get_user_model().objects.create_user(email='deolhonocorona@example.com', password='123456')
    ...
    def test_wrong_password(self):
        user = authenticate(username='deolhonocorona@example.com', password='123456')
        self.assertFalse(user is not None and user.is_authenticated)
