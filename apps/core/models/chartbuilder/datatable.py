...
class DataTable:
    ...
    def cidade(self, cidade):
        ...
        if (
            cidade != "Caçu"
            and cidade != "Chapadão do Céu"
            and cidade != "Jataí"
            and cidade != "Mineiros"
            and cidade != "Rio Verde"
            and cidade != "Santa Helena"
        ):
        ...
        for row in dados:
            ...
            if (
                len(dados_preparados) > 1
                and dados_preparados[-1]["Data"] == dados_preparados[-2]["Data"]
            ):
        ...
        resumoJson = data_table_resumo.ToJSon(
            columns_order=tuple(categorias), order_by="Data"
        )
        ...
        todasJson = data_table.ToJSon(columns_order=tuple(categorias), order_by="Data")
